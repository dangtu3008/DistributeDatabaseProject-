...
go
create trigger insertOrder on ORDERS_HCMLater2021 after insert as
begin
...
go
create trigger insertBookStock on BOOKSTOCK_HanoiNoMoreThan60000 after insert as
begin
	declare @countS1 int, @countS2 int, @countS3 int, @countS3_2 int;
...
go
create trigger deleteBookstockHCM on BOOKSTOCK_HanoiNoMoreThan60000 after delete as
begin
